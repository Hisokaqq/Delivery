...
import { selectBasketItems, selectBasketItemTotal } from '../features/BasketSlice'
  ...
  return (
    <View  className="absolute bottom-10 w-full z-50">
      <TouchableOpacity onPress={()=>navigation.navigate("Basket")} className="mx-5 bg-[#00CCBB] p-4 rounded-lg flex-row items-center space-x-1">
        ...
        <Text className="flex-1 text-center text-white font-extrabold text-xl">View Basket</Text>
